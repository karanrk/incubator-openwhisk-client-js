...
The openwhisk-client-js SDK supports the use of above mentioned proxies through third-party http agent such as [proxy-agent](https://github.com/TooTallNate/node-proxy-agent "proxy-agent Github page")
